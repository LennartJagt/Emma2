...
class InvoicedetailsTest < ApplicationSystemTestCase
  ...
  test "creating a Invoicedetail" do
    ...
    fill_in "Amount", with: @invoicedetail.amount
    fill_in "Date", with: @invoicedetail.date
    fill_in "Name", with: @invoicedetail.name
    fill_in "Price", with: @invoicedetail.price
    fill_in "Productid", with: @invoicedetail.productid
    fill_in "Productinvoicetext", with: @invoicedetail.productinvoicetext
    fill_in "Purchaseinvoice", with: @invoicedetail.purchaseinvoice
    fill_in "Quantity", with: @invoicedetail.quantity
    fill_in "Ref@invoice@invoicedetail", with: @invoicedetail.ref@Invoice@invoicedetail
    fill_in "Ref@patient@invoicedetail", with: @invoicedetail.ref@Patient@invoicedetail
